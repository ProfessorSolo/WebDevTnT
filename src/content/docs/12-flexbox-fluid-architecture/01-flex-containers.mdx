...
## 🏛 Flex Container Diagram (Coming from the Demo Lab)

In the Flexbox Fluidity demo, you’ll see a scene just like this illustration:

- a glowing **container frame**
- direct children lit up as **flex items**
- arrows marking the main axis and cross axis

Use that diagram as your mental anchor:

> “This parent controls the line.  
> Everything else is just content inside the actors.”
...
<LinkButton href="/lessons/12-flexbox-fluidity-the-architects-line/02-flex-items">
  Continue to 02 — Flex Items: The Line-Crafter’s Actors
</LinkButton>
