...
<LinkButton
  href="https://github.com/ProfessorSolo/WebDevTnT-CSS-Grid-the-Second-Dimension"
  target="_blank"
  icon="external"
  variant="secondary"
>
...
```bash
git clone https://github.com/ProfessorSolo/WebDevTnT-CSS-Grid-Second-Dimension.git
```
...
### 🎥 Watch the Grid Lesson — _Coming Soon_
