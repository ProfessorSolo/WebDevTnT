...
💡 _Think of this as telling Git: “Hey, pay attention to this one.”_
...
💡 _`git add` stores, `git diff --staged` reviews, `git restore --staged` erases from short-term memory._
...
💡 _Git never forgets — unless you tell it to._
