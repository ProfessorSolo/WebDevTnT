...
It’s the best place to _see each spell in isolation_, poke at the DOM, flip states, toggle attributes, and watch how a selector transforms the entire story of the markup.
